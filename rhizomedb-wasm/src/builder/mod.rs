...
use anyhow::Result;
use rhizomedb::{kernel, value::Any, var::TypedVar, RuleVars};
...
pub struct ProgramBuilder {
    inner: Rc<RefCell<rhizomedb::ProgramBuilder>>,
}
...
impl ProgramBuilder {
    pub fn new(p: rhizomedb::ProgramBuilder) -> Result<Self> {
        Ok(Self {
            inner: Rc::new(RefCell::new(p)),
        })
    }
    pub fn take(self) -> rhizomedb::ProgramBuilder {
        self.inner.take()
    }
}
